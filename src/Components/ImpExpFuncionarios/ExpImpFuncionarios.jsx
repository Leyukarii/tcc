...
export default function ExpImpFuncionarios() {
  ...
  return (
    <div className="p-7">
      <Button onClick={handleDownload}>Download CSV Funcionarios</Button>
      <div className="grid w-full max-w-sm items-center gap-1.5 pt-10">
        <Label htmlFor="picture">CSV Funcionarios</Label>
        <Input id="picture" type="file" onChange={handleFileChange} />
        <Button className="mt-2" onClick={handleUpload}>
          Upload CSV Funcionarios
        </Button>
      </div>
      {successMessage && (
